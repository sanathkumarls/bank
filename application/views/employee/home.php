...
if(isset($_SESSION['email']) && isset($_SESSION['role']))
{
    ...
    $result2 = $objLoan->getPendingVerification();
...
<div class="accordion">
    <table class="table-bordered" width="100%" cellspacing="10px" border="10px" cellpadding="10%" align="center">
        ...
        if($result2)
        {
            ...
            <td>".$row['l_type']."</td>
            <td>".$row['l_amt']."</td>
            <td><form method='post' action='verify.php'><input type='text' name='c_id' value='".$row['c_id']."' hidden><button class='btn-primary' name='submit' value='".$row['l_application_no']."'>Verify </button></form></td>
        </tr>";
            }
        }
        else
